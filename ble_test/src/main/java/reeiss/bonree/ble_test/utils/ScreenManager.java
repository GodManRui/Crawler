...
import reeiss.bonree.ble_test.smarthardware.activity.SinglePixelActivity;
...
public class ScreenManager {
    ...
    getScreenManagerInstance(Context context) {
    ...
    public void startActivity() {
        ...
        Intent intent =
                new Intent(mContext, SinglePixelActivity.class);
