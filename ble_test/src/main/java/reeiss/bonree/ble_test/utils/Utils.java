...
public class Utils {
    ...
    public static int getRssiDrawable(int rssi) {
        if (rssi > -50) {
            return R.mipmap.ic_rssi_5;
        } else if (rssi > -65) {
            return R.mipmap.ic_rssi_4;
        } else if (rssi > -85) {
            return R.mipmap.ic_rssi_3;
        } else if (rssi > -100) {
            return R.mipmap.ic_rssi_2;
        } else if (rssi > -110) {
            return R.mipmap.ic_rssi_1;
        } /*else if (rssi > -120) {
