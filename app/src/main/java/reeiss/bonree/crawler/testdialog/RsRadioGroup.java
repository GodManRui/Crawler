...
public class RsRadioGroup extends RadioGroup {
    private static final String TAG = "RadioGroupEx";
    private int i;

    public RsRadioGroup(Context context) {
        super(context);
        Log.e("JerryZhu", "RsRadioGroup空构造: ");
    }

    public RsRadioGroup(Context context, AttributeSet attrs) {
        super(context, attrs);
        Log.e("JerryZhu", "RsRadioGroup有参构造: ");
    }

    @Override
    protected void onMeasure(int widthMeasureSpec, int heightMeasureSpec) {
        Log.e("JerryZhu", "onMeasure: " + i++);
